...
function cardTable() {
    return(
        ...
        <CardTab titulo="Políticas de Segurança" img="../../public/images/card-1.png" texto="As políticas de segurança para a infância e juventude têm como objetivo garantir a proteção física, emocional e social desses grupos. Algumas das principais políticas de segurança para a infância e juventude incluem:"></CardTab>
